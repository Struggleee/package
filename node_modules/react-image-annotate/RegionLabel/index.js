...
export default memo(RegionLabel, function (prevProps, nextProps) {
  return prevProps.editing === nextProps.editing && prevProps.region.x === nextProps.region.x && prevProps.region.y === nextProps.region.y && prevProps.region.tags === nextProps.region.tags && prevProps.region.cls === nextProps.region.cls && prevProps.region.color === nextProps.region.color && prevProps.region.highlighted === nextProps.region.highlighted;
});