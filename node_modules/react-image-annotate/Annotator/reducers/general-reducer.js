    ...
    case "MOUSE_DOWN":
      {
            ...
            case "DRAW_POLYGON":
              {
                ...
                if (!_polygon2) break;
                return setIn(state, [].concat(_toConsumableArray(pathToActiveImage), ["regions", _regionIndex7]), _objectSpread({}, _polygon2, {
        ...
        var _regions = _toConsumableArray(activeImage.regions || []).map(function (r) {
          return _objectSpread({}, r, {
            editingLabels: false
          });
    ...
    case "MOUSE_UP":
      {
        ...
        switch (state.mode.mode) {
          case "RESIZE_BOX":
            {
              if (state.mode.isNew) {
                if (Math.abs(state.mode.original.x - _x2) < 0.01 && Math.abs(state.mode.original.y - _y2) < 0.01) {
    ...
    case "CHANGE_REGION":
      {
        ...
        return setIn(state, [].concat(_toConsumableArray(pathToActiveImage), ["regions", _regionIndex8]), _region2);
      }
    ...
    case "OPEN_REGION_EDITOR":
      {
        ...
        }), [_regionIndex9], _objectSpread({}, (activeImage.regions || [])[_regionIndex9], {
          highlighted: true,
          editingLabels: true
        }));
    ...
    case "CLOSE_REGION_EDITOR":
      {
        ...
        return setIn(state, [].concat(_toConsumableArray(pathToActiveImage), ["regions", _regionIndex10]), _objectSpread({}, (activeImage.regions || [])[_regionIndex10], {
          editingLabels: false
        }));
      }
