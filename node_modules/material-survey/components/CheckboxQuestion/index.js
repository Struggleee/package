...
function CheckboxQuestion({
  ...
  }), question.hasOther && answer.concat(null).filter(a => !question.choices.some(c => c === a || (c || {}).value === a)).map((otherValue, i) => _react2.default.createElement(CheckboxItem, null, _react2.default.createElement(_Checkbox2.default, {
    tabIndex: -1,
    onClick: () => {
      if (otherValue !== null) {
